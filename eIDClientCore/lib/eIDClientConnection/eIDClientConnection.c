...
EID_CLIENT_CONNECTION_ERROR eIDClientConnectionStartHttp(P_EIDCLIENT_CONNECTION_HANDLE hConnection, const char *const url, const char *const sid, const char *const psk, enum HttpHeaderInclusion includeHeader, enum HttpRedirect httpRedirect)
{
	 ...
	 */
	if(psk != NULL){
		curlVal = curl_easy_setopt(curl, CURLOPT_SSL_CIPHER_LIST, /*"RSA-PSK-AES256-GCM-SHA384:RSA-PSK-AES128-GCM-SHA256:RSA-PSK-AES256-CBC-SHA384:RSA-PSK-AES128-CBC-SHA256:*/"RSA-PSK-AES256-CBC-SHA:RSA-PSK-AES128-CBC-SHA:RSA-PSK-3DES-EDE-CBC-SHA");
	} else {
