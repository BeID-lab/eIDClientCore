...
NPACLIENT_ERROR nPAeIdUserInteractionCallback_gui(
    const SPDescription_t *description, UserInput_t *input)
{
    start_gui(description, input); 

    char buf[BUFFERSIZE];
    snprintf(buf, BUFFERSIZE, "%s", (char *) description->name.pDataBuffer);
    // snprintf(buf, MAX(sizeof buf, description->name.bufferSize), (char *) description->name.pDataBuffer);
    // buf[(sizeof buf) - 1] = '\0';
    printf("serviceName: %s\n", buf);
    snprintf(buf, BUFFERSIZE, "%s", (char *) description->url.pDataBuffer);
    // snprintf(buf, MAX(sizeof buf, description->url.bufferSize), (char *) description->url.pDataBuffer);
    // buf[(sizeof buf) - 1] = '\0';
    printf("serviceURL:  %s\n", buf);
    snprintf(buf, BUFFERSIZE, "%s", (char *) description->description.pDataBuffer);
    ...
    {
        snprintf(buf, BUFFERSIZE, "%s", (char *) description->transactionInfo.pDataBuffer);
    ...
    {
        snprintf(buf, BUFFERSIZE, "%s", (char *) description->transactionInfoHidden.pDataBuffer);
